...
static const MDFNSetting_EnumList PSGRevisionList[] =
{
 ...
 { "enhanced", PCE_PSG::REVISION_ENHANCED, "Enhanced", "Emulator-only pseudo-revision, designed to reduce clicking and audio artifacts in games designed for either real revision." },
...
extern MDFNGI EmulatedPCE_Full;
static bool IsSGX;
static bool IsHES;
...
static int LoadCD(std::vector<CDIF *> *CDInterfaces)
{
 ...
 if(!HuCLoad(fp.f_data + headerlen, fp.f_size - headerlen, 0, disable_bram_cd, PCE_ACEnabled ? SYSCARD_ARCADE : SYSCARD_3))
 {
  return(0);
 }
...
static MDFNSetting PCESettings[] = 
{
  ...
  { "pce.adpcmlp", MDFNSF_NOFLAGS, "Enable dynamic ADPCM lowpass filter.",
	"This makes ADPCM voices sound less \"harsh\", however, the downside is that it will cause many ADPCM sound effects to sound a bit muffled.", MDFNST_BOOL, "0", NULL, NULL, NULL, CDSettingChanged },

  { "pce.psgrevision", MDFNSF_NOFLAGS, "Select PSG revision.", "WARNING: HES playback will always use the \"huc6280a\" revision if this setting is set to \"match\", since HES playback is always done with SuperGrafx emulation enabled.", MDFNST_ENUM, "huc6280a", NULL, NULL, NULL, NULL, PSGRevisionList  },

  { "pce.cdpsgvolume", MDFNSF_NOFLAGS, "PSG volume when playing a CD game.", NULL, MDFNST_UINT, "100", "0", "200", NULL, CDSettingChanged },
  { "pce.cddavolume", MDFNSF_NOFLAGS, "CD-DA volume.", NULL, MDFNST_UINT, "100", "0", "200", NULL, CDSettingChanged },
  { "pce.adpcmvolume", MDFNSF_NOFLAGS, "ADPCM volume.", NULL, MDFNST_UINT, "100", "0", "200", NULL, CDSettingChanged },

  { "pce.vramsize", MDFNSF_NOFLAGS, "Size of emulated VRAM per VDC in 16-bit words.  DO NOT CHANGE THIS UNLESS YOU KNOW WTF YOU ARE DOING.", NULL, MDFNST_UINT, "32768", "32768", "65536" },
  { NULL }
};
